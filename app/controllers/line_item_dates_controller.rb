...
class LineItemDatesController < ApplicationController
    ...
    def create
        ...
        if @line_item_date.save
            respond_to do |format|
                format.html { redirect_to quote_path(@quote), notice: "Date was succeffully created." }
                format.turbo_stream { flash.now[:notice] = "Date was succcefully created."}
            end
        else
    ...
    def destroy
        ...
        respond_to do |format|
            ...
            format.turbo_stream { flash[:notice] = "Date was successfully destroyed." }
        end
    end
